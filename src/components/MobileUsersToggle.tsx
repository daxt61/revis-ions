  ...
  return (
    <div className="lg:hidden">
      <button
        ...
        className="fixed bottom-6 left-6 w-14 h-14 bg-card border border-border text-primary rounded-2xl shadow-2xl flex items-center justify-center z-40 hover:scale-110 active:scale-95 transition-all"
      >
        <Users size={24} />
      </button>
