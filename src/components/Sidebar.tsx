...
export default function Sidebar() {
  ...
  return (
    <div className="bg-card rounded-2xl shadow-sm border p-4 sticky top-20">
      <h2 className="font-semibold mb-4 text-card-foreground border-b border-border pb-2">Utilisateurs</h2>
