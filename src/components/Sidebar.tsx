...
export default function Sidebar() {
  ...
  return (
    <div className="bg-card rounded-2xl shadow-sm border border-border-border p-4 sticky top-20 overflow-hidden">
      <h2 className="font-semibold mb-4 text-foreground border-b border-border-border pb-2">Utilisateurs</h2>
