...
export default function Sidebar() {
  ...
  return (
    <div className="bg-card rounded-xl shadow-sm border border-border p-4 sticky top-20">
        ...
        {profiles.map((profile) => (
          <li key={profile.id} className="flex items-center gap-3">
            <div className="relative">
              <div className="w-8 h-8 bg-border rounded-full flex items-center justify-center text-primary font-bold text-xs">
